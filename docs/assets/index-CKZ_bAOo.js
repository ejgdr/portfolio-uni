(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function r(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(n){if(n.ep)return;n.ep=!0;const o=r(n);fetch(n.href,o)}})();function v(){const e=document.createElement("header"),t="/portfolio-uni/";e.className="header",e.innerHTML=`
  ...
  `,setTimeout(()=>b(),0),t}function y(e,t){return`
  ...
  `,t}function S(e,t){return e.find(a=>a.platform===t)?.url||"#"}function k(e){const t=document.createElement("footer");return t.id="contact",t.className="footer",t.innerHTML=`
    <div class="container">
...
}`,lessonsLearned:["Serverless Microservices Architecture: Cloudflare Workers for products, payments, orders + API gateway for routing and rate limiting","Cross-platform App: Single Flutter codebase supporting Android, iOS, and Web","Tech Stack Integration: Firebase + Cloudflare Workers + Stripe payments","Real-time Inventory Management: CRUD operations for products with immediate updates","Order Management Panel: Order status updates, tracking, admin oversight","This project is still live, so check it out! https://packwhisperer.com"]},{id:"crypto-idle-game",title:"Crypto Idle Mining Game with ApexCharts",videoUrl:"https://www.youtube.com/embed/TBvWNGk7U6Q",technologies:["HTML5","CSS","JavaScript","ApexCharts","LocalStorage"],story:"Built an idle mining game featuring tier-based progression and real-time data visualization. Implemented ApexCharts for displaying mining rates, currency accumulation, and tier progression. Demonstrated Software Development Life Cycle principles including requirements analysis, design, implementation, testing, and maintenance.",partialCode:`/**\r
...
}`,lessonsLearned:["Entity framework relationships are complex but powerful","TryUpdateModelAsync is a more secure than binding entire models to prevent overposting attacks","User experience matters: implemented Bootstrap for responsive and modern UI design","Database initialization and seeding are crucial for testing and development purposes","Comprehensive understanding of ASP.NET Core MVC architecture and routing mechanisms saved development time and improved maintainability"]}],R="Ema Guillen",x="Software Engineering Student",M="emajguillen@gmail.com",I="Building Quality Software | QA Enthusiast | Full-Stack Developer",B="Software Engineering student at BYU-Idaho. Passionate about software quality, testing automation, and building robust applications. Currently seeking Summer 2026 internship opportunities.",P=[{platform:"LinkedIn",url:"https://www.linkedin.com/in/ema-guillen/",icon:"linkedin"},{platform:"GitHub",url:"https://github.com/ejgdr",icon:"github"},{platform:"Email",url:"mailto:emajguillen@gmail.com",icon:"email"}],H="/resume/EmaGuillen_Resume.pdf",u={name:R,title:x,email:M,tagline:I,bio:B,socials:P,resumeUrl:H},h=document.querySelector("#app");h.innerHTML="";function $(){const e=v(),t=g(u),r=f(L),a=C(u),n=k(u);h.append(e,t,r,a,n),document.querySelectorAll('a[href^="#"]').forEach(l=>{l.addEventListener("click",function(s){s.preventDefault();const c=s.currentTarget.getAttribute("href");if(c&&c!=="#"){const p=document.querySelector(c);p&&p.scrollIntoView({behavior:"smooth",block:"start"})}})});const o={threshold:.1,rootMargin:"0px 0px -50px 0px"},i=new IntersectionObserver(l=>{l.forEach(s=>{s.isIntersecting&&(s.target.classList.add("fade-in"),i.unobserve(s.target))})},o);document.querySelectorAll(".card").forEach(l=>{i.observe(l)})}$();console.log("🚀 Portfolio loaded successfully!");console.log("Built with Vite + TypeScript");
