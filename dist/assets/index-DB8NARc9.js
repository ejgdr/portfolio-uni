...
}`,lessonsLearned:["Entity framework relationships are complex but powerful","TryUpdateModelAsync is a more secure than binding entire models to prevent overposting attacks","User experience matters: implemented Bootstrap for responsive and modern UI design","Database initialization and seeding are crucial for testing and development purposes","Comprehensive understanding of ASP.NET Core MVC architecture and routing mechanisms saved development time and improved maintainability"]}],L="Ema Guillen",I="Software Engineering Student",R="emajguillen@gmail.com",M="Building Quality Software | QA Enthusiast | Full-Stack Developer",x="Software Engineering student at BYU-Idaho. Passionate about software quality, testing automation, and building robust applications. Currently seeking Summer 2026 internship opportunities.",B=[{platform:"LinkedIn",url:"https://www.linkedin.com/in/ema-guillen/",icon:"linkedin"},{platform:"GitHub",url:"https://github.com/ejgdr",icon:"github"},{platform:"Email",url:"mailto:emajguillen@gmail.com",icon:"email"}],P="/resume/EmaGuillen_Resume.pdf",u={name:L,title:I,email:R,tagline:M,bio:x,socials:B,resumeUrl:P},h=document.querySelector("#app");h.innerHTML="";function A(){const e=v(),t=g(u),r=f(E),a=b(u),n=S(u);h.append(e,t,r,a,n),document.querySelectorAll('a[href^="#"]').forEach(l=>{l.addEventListener("click",function(s){s.preventDefault();const c=s.currentTarget.getAttribute("href");if(c&&c!=="#"){const p=document.querySelector(c);p&&p.scrollIntoView({behavior:"smooth",block:"start"})}})});const o={threshold:.1,rootMargin:"0px 0px -50px 0px"},i=new IntersectionObserver(l=>{l.forEach(s=>{s.isIntersecting&&(s.target.classList.add("fade-in"),i.unobserve(s.target))})},o);document.querySelectorAll(".card").forEach(l=>{i.observe(l)})}A();console.log("🚀 Portfolio loaded successfully!");console.log("Built with Vite + TypeScript");
